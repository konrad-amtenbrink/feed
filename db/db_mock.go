...
func (m *MockDatabase) CreateDocument(ctx context.Context, doc Document, userId uuid.UUID) (uuid.UUID, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateDocument", ctx, doc, userId)
...
func (mr *MockDatabaseMockRecorder) CreateDocument(ctx, doc, userId interface{}) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateDocument", reflect.TypeOf((*MockDatabase)(nil).CreateDocument), ctx, doc, userId)
}
